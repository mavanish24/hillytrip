...
export const INITIAL_INVENTORY_SEED: InventoryItem[] = [
  // 1. Homestay Rooms
  {
    ...
    status: 'Active',
    images: ['/images/hillytrip/homestay.svg'],
  ...
  },
  {
    ...
    status: 'Active',
    images: ['/images/hillytrip/snow-mountain.svg'],
  ...
  // 2. Vehicles
  {
    ...
    status: 'Active',
    images: ['/images/hillytrip/taxi-transit.svg'],
  ...
  // 3. Camping Slots
  {
    ...
    status: 'Active',
    images: ['/images/hillytrip/himalayan-landscape.svg'],
  ...
  // 4. Guided Tours & Activities
  {
    ...
    status: 'Active',
    images: ['/images/hillytrip/monastery.svg'],
  ...
  // 5. Restaurant Tables
  {
    ...
    status: 'Active',
    images: ['/images/hillytrip/himalayan-food.svg'],
