...
export interface TaxiOperator {
  ...
  business_id?: string | null; // UUID references businesses.id
...
export interface OperatorFareQuote {
  id: string;
  operator_id: string;
  operator_name?: string;
  business_name?: string;
  from_entity_id: string;
  from_entity_type: 'taxi_stand' | 'destination' | 'attraction';
  to_entity_id: string;
  to_entity_type: 'taxi_stand' | 'destination' | 'attraction';
  route_id?: string | null;
  service_type: 'shared_taxi' | 'reserved_car';
  vehicle_category: string;
  fare_min: number;
  fare_max: number;
  fare_unit: 'per_seat' | 'per_vehicle';
