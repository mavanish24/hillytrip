...
function ContributorLightboxViewer({
  url,
  caption,
  onNext,
  onPrev,
  ...
  return (
    <div 
      className="flex-grow flex items-center justify-center p-4 relative z-10 overflow-hidden touch-pan-y select-none"
      {...touchHandlers}
    >
      <button
        onClick={(e) => {
  ...
  const getContributorData = () => {
    ...
    if (slug === 'anjali-bhutia' || (slug === 'me' && user?.name?.toLowerCase().includes('anjali'))) {
      return {
        ...
        avatar: 'https://api.dicebear.com/7.x/initials/svg?seed=AnjaliRai',
        stats: {
          photos: 42,
          reviews: 18,
          attractions: 6,
        ...
        photos: [
          { id: 'anj-p1', url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Grand%20Himalayan%20Landscape.png', caption: 'Dramatic river banks along the pristine Teesta valley basin.', likes: 58, views: 2400, comments: 12, date: '2026-05-12' },
          { id: 'anj-p2', url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Grand%20Himalayan%20Landscape.png', caption: 'Kanchenjunga peaks piercing through early morning mist clouds.', likes: 112, views: 5600, comments: 24, date: '2026-06-01' },
          { id: 'anj-p3', url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Grand%20Himalayan%20Landscape.png', caption: 'Quiet village pathway in Rishop bordered by ancient pine woods.', likes: 74, views: 3100, comments: 8, date: '2026-04-20' },
          { id: 'anj-p4', url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Grand%20Himalayan%20Landscape.png', caption: 'Mossy boulder cascades at the secret Changey waterfall point.', likes: 49, views: 1850, comments: 4, date: '2026-03-15' },
          { id: 'anj-p5', url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Grand%20Himalayan%20Landscape.png', caption: 'Layers of green organic tea hedges winding down the Kurseong slopes.', likes: 65, views: 2900, comments: 9, date: '2026-02-28' },
          { id: 'anj-p6', url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Grand%20Himalayan%20Landscape.png', caption: 'Himalayan sunset over a tiny wooden homestay chimney in Sittong.', likes: 60, views: 2600, comments: 7, date: '2026-05-25' }
        ],
        reviews: [
    ...
    if (slug === 'amit-sharma' || (slug === 'me' && user?.name?.toLowerCase().includes('amit'))) {
      return {
        ...
        avatar: 'https://api.dicebear.com/7.x/initials/svg?seed=AmitSharma',
        stats: {
          photos: 28,
          reviews: 12,
          attractions: 4,
        ...
        photos: [
          { id: 'amt-p1', url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Grand%20Himalayan%20Landscape.png', caption: 'The absolute majesty of Mount Kanchenjunga bathed in golden sunrise.', likes: 88, views: 4200, comments: 14, date: '2026-05-28' },
          { id: 'amt-p2', url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Grand%20Himalayan%20Landscape.png', caption: 'Lush organic mist-bathed cardamom trails in North Sikkim.', likes: 52, views: 1900, comments: 6, date: '2026-06-10' },
          { id: 'amt-p3', url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Grand%20Himalayan%20Landscape.png', caption: 'Pristine forest canopy overhead during the trek to Alpine Pass.', likes: 45, views: 1600, comments: 3, date: '2026-04-12' },
          { id: 'amt-p4', url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Grand%20Himalayan%20Landscape.png', caption: 'Breathtaking layered valleys under rolling cloud formations.', likes: 62, views: 2100, comments: 10, date: '2026-03-08' }
        ],
        reviews: [
    ...
    return {
      ...
      avatar: profileAvatarUrl || 'https://api.dicebear.com/7.x/initials/svg?seed=AnjaliRai',
      ...
      photos: [
        { id: 'fallback-p1', url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Grand%20Himalayan%20Landscape.png', caption: 'Quiet mountain road surrounded by thick green forest.', likes: 12, views: 450, comments: 2, date: '2026-05-15' },
        { id: 'fallback-p2', url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Grand%20Himalayan%20Landscape.png', caption: 'Stunning organic mountain slope in the late evening glow.', likes: 12, views: 400, comments: 4, date: '2026-05-02' }
      ],
      reviews: [
      ...
      <AnimatePresence>
        {lightboxIndex !== null && (
          ...
          >
            ...
            {/* Middle Main Picture Viewer with touch swipe support */}
            <ContributorLightboxViewer
              url={filteredPhotos[lightboxIndex].url}
              caption={filteredPhotos[lightboxIndex].caption}
