...
export default function RouteReviews({
  ...
  const initialReviews: Review[] = [
    {
      ...
      userAvatar: "https://api.dicebear.com/7.x/initials/svg?seed=Reviewer1",
      rating: 5,
    ...
    },
    {
      id: 'rev-2',
      userName: "Meera Nair",
      userAvatar: "https://api.dicebear.com/7.x/initials/svg?seed=Reviewer2",
      rating: 4,
  ...
  const handleSubmitReview = (e: React.FormEvent) => {
    ...
    const newRev: Review = {
      id: `rev-${Date.now()}`,
      userName: formName,
      userAvatar: 'https://api.dicebear.com/7.x/initials/svg?seed=' + encodeURIComponent(formName || 'Reviewer'),
      rating: formRating,
      title: formTitle,
      content: formContent,
      visitDate: 'Just now',
