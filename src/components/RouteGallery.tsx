...
function RouteGalleryLightboxImageViewer({
  url,
  alt,
  onNext,
  onPrev,
  ...
  return (
    <div className="w-full h-[55vh] md:h-[65vh] flex items-center justify-center rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-slate-950">
    ...
    return [
      {
        id: 'gal-1',
        type: 'image',
        url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Snow%20Mountains.png',
      ...
      },
      {
        id: 'gal-2',
        type: 'image',
        url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/attractions/Trek%20%20Hiking.png',
      ...
      },
      {
        id: 'gal-3',
        type: 'pano360',
        url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Pine%20Forest%20Village.png',
      ...
      },
      {
        id: 'gal-4',
        type: 'image',
        url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Darjeeling%20Hills%20Village.png',
      ...
      },
      {
        id: 'gal-5',
        type: 'image',
        url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/Typical%20Himalayan%20Village.png',
      ...
      },
      {
        id: 'gal-6',
        type: 'image',
        url: 'https://ijyzcvzaosfimvrzgopb.supabase.co/storage/v1/object/public/destinations/High-Altitude%20Village.png',
        ...
        >
          ...
          >
            ...
            {items[lightboxIndex].type !== 'pano360' ? (
              <RouteGalleryLightboxImageViewer
