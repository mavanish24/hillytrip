  ...
  const carouselItems = [
    {
      id: 'All',
      name: 'All Sights',
      img: '/images/hillytrip/himalayan-landscape.svg',
    ...
    ...(categoriesList || []).map(cat => {
      ...
      if (catLower.includes('waterfall')) {
        ...
        img = '/images/hillytrip/north-bengal-hills.svg';
        ...
        img = '/images/hillytrip/tea-garden.svg';
...
export default AttractionCategoriesCarousel;
